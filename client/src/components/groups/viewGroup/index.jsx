                ...
                >
                  ...
                  <Box>
                    ...
                    >
                      ...
                      {groupExpense.total
                        ? convertToCurrency(groupExpense.total)
                        : 0}
                    </Typography>
                  </Box>
                </Stack>
                ...
                >
                  ...
                  <Box>
                    ...
                    >
                      ...
                      {findUserSplit(group?.split) < 0
                        ? convertToCurrency(
                            Math.abs(findUserSplit(group?.split))
                          )
                        : 0}
                    </Typography>
                  </Box>
                  ...
                  {alertExpense ? (
                    ...
                    >
                      <Typography
                        ...
                        textAlign={"center"}
                      >
                        No expense present for this group {group.groupName}
                        Add your first group expense now <br />
                        <Link
                          component={RouterLink}
                          to={dataConfig.ADD_EXPENSE_URL + group?._id}
                        >
